...
import com.rb.sss.service.ServDemo_10142Service;
import com.rb.core.rest.ConfigIdentifier;
import com.rb.core.rest.GenericApi;

@Path("/api/v1/employees")
public class ServDemo_10142Controller {

    public static final Logger logger = LoggerFactory.getLogger(ServDemo_10142Controller.class);
	@Inject
	ServDemo_10142Service service;
